...
:::info
Both peer dependencies are optional. If you only need the React layer, install React. If you only need the Playwright layer for testing, install Playwright.
:::
